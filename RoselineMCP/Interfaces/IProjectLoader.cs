...
/// <summary>
/// Loads a C# project (by name, directory, or <c>.csproj</c> path) into a fresh
/// <see cref="Workspace"/> for structural/semantic queries and edits. When the project
/// belongs to a solution, the whole solution is opened so cross-project references, callers, and
/// renames resolve correctly; otherwise the single project is opened on its own.
/// </summary>
public interface IProjectLoader
{
    ...
    /// </summary>
    /// <param name="project">Project name, directory containing a single <c>.csproj</c>, or a path to a <c>.csproj</c> file.</param>
