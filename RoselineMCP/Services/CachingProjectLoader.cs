...
public sealed class CachingProjectLoader : IProjectLoader, IDisposable
{
    ...
    /// name="resolvedPath"/> / <paramref name="targetPath"/> / <paramref
    /// name="unresolvedAnalyzerReferences"/> pass-throughs are held in one place — dropping any at a hand-copied
